    ...
    return (
        <RoughNotationGroup show={true}>
          <div className="flex flex-col z-10">
            <h1 className="text-2xl font-display font-semibold text-neutral-800 dark:text-neutral-100 mt-16">
              hello world,{" "}
            ...
            <p className="text-xs mt-2 font-medium text-neutral-400 dark:text-neutral-500">he/him</p>
            <p className="mt-10 font-medium text-neutral-700 dark:text-neutral-300">
            ...
            <p className="font-medium mt-10 text-neutral-700 dark:text-neutral-300">
              Have a{" "}
